...
if __name__ == "__main__":
    ...
    write_dir="/data/pt_life/data_fbeyer/PLS_on_TBM_obesity_markers/PLS/results/sampleN748/N748_TIV_regression/perm_boot_logtr_all_regressed_n9_medication/"
    brain_data=np.load(analysis_dir+'regression_N748/brain_data_mask0.3_N748.npy')
    Ob = np.load(analysis_dir + 'BMI_lab_measures_N748_logtr_all_reg_medication_corrected.npy')
