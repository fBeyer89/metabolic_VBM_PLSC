...
if __name__ == "__main__":
    ...
    write_dir="/data/pt_life/data_fbeyer/PLS_on_TBM_obesity_markers/PLS/results/sampleN748/N748_TIV_regression/CV_logtr_all_regressed_n9_wo_adipo_secondrun/"
    n_rep=20
    perm_n=1000
    n_comp=9
    ...
    brain_data = brain_data[np.invert(exclude_adipo), :]
    Ob = np.load(analysis_dir + 'BMI_lab_measures_N748_logtr_all_reg_woadipo.npy') 
    ...
    for i in np.arange(0,n_rep):
        #create 10 80% to 20% data splits (599 vs 149)
